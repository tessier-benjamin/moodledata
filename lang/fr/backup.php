...
/**
 * Strings for component 'backup', language 'fr', version '3.10'.
 *
 * @package     backup
 * @category    string
...
$string['configgeneralcontentbankcontent'] = 'Définit le réglage d\'inclusion de contenu de la banque de contenus dans les sauvegardes.';
...
$string['configlegacyfiles'] = 'Ce réglage détermine s\'il faut inclure les fichiers de cours obsolètes dans les sauvegardes. Le fichiers de cours obsolètes proviennent de versions de Moodle antérieures avant la version 2.0.';
